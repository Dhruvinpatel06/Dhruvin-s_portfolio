...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Nilkanth Enterprise",
    description: [
      "Managing daily office operations and administrative activities.",
      "Introduced digital solutions that improved productivity and reduced manual effort.",
      "Organized and maintained physical and digital documentation.",
      "Assisted with inventory tracking, budgeting, and financial record management.",
    ],
    skills: [],
  },
  {
    ...
    company: "CodeAlpha",
    description: [
      "Developed backend applications using Flask and Django.",
      "Built and managed databases using SQLite and MongoDB.",
      "Designed and implemented RESTful APIs with Node.js and Express.js.",
      "Improved application performance and debugging skills through hands-on projects.",
    ],
    skills: [
      SkillNames.NODEJS,
      SkillNames.EXPRESS,
  ...
  },
  {
    ...
    description: [
      "Pursuing B.Tech in CSE with focus on AI, full-stack development, and software engineering.",
      "Participated in national and university-level hackathons.",
      "Built AI-powered and full-stack web applications as part of project-based learning.",
      "Explored AI, Machine Learning, Computer Vision, and Robotics with Arduino.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.REACT,
